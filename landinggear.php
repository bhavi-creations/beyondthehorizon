<?php include 'header.php'; ?>
    ...
    <section id="about-hero" style="position: relative; height: 500px; margin-top: 140px;">
        <!-- Background Image -->
        <img src="./assets/img/landing_gear_1.png" alt="About Us" class="img-fluid w-100 h-100" style="object-fit: cover;">
    ...
    <section class="service-section py-5" id="landinggear">
        <div class="container">
            <div class="row align-items-center">

                <!-- Image -->
                <div class="col-lg-6 col-12 mb-4 mb-md-0">
                    <img src="assets/img/landing_gear.png" alt="Base Maintenance" class="img-fluid rounded shadow">
                </div>
