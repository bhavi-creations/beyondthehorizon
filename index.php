...
<section>
    <div id="heroCarousel" class="carousel carousel_section slide carousel-fade" data-bs-ride="carousel"
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item position-relative">
                <img src="./assets/img/slider4.png" class="d-block w-100" alt="AI Technology"
                    style="height: 600px; object-fit: cover;">
                <div
                    style="position: absolute; top:0; left:0; width:100%; height:100%; background-color: rgba(0,0,0,0.5); z-index:1;">
                </div>
                    ...
                    <div class="d-flex align-items-start gap-4">
                        ...
                        <div>
                            ...
                            <div class="highlight-badge px-4 py-3 rounded-3 d-inline-block">
                                ...
                                <span class="d-block small mt-1">vs. competitive market</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="service-card">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <div class="feature-card text-start" id="innovation_section">
...
<section id="sustainability" class="section   mro-section">
    <div class="container">
        <div class="text-center mb-5">
